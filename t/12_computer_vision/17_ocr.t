...
can_ok $cv, qw/_ocr_request/;

my $img = 'http://example.com/hoge.jpg';
my $req = $cv->_ocr_request($img, language => "Ja");
isa_ok $req, 'HTTP::Request';
like $req->uri, qr|^https://westus.api.cognitive.microsoft.com/vision/v1.0/ocr|;
like $req->uri, qr|language=Ja|;
is $req->method, 'POST';
