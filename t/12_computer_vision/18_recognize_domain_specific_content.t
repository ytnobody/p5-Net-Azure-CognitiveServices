...
can_ok $cv, qw/_recognize_domain_specific_content_request/;

my $img = 'http://example.com/hoge.jpg';
my $req = $cv->_recognize_domain_specific_content_request($img, model => "landmarks");
isa_ok $req, 'HTTP::Request';
like $req->uri, qr|^https://westus.api.cognitive.microsoft.com/vision/v1.0/models/landmarks/analyze|;
is $req->method, 'POST';
